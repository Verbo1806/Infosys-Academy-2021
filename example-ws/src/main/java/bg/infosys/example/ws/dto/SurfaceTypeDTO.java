...
@NoArgsConstructor
@AllArgsConstructor
@ApiModel(description = "Class representing a surface type in the application")
public class SurfaceTypeDTO {
	@ApiModelProperty(
			  value = "Unique string identifier of the Surface Type",
			  name = "code",
			  dataType = "String",
			  example = "ST1",
			  required = true,
	...
	@ApiModelProperty(
			  value = "Name of the Surface Type",
			  name = "name",
			  dataType = "String",
			  example = "Surface Type 1",
			  required = true,
			  position = 1)
	...
	@ApiModelProperty(
			  value = "Description of the Surface Type",
			  name = "description",
			  dataType = "String",
			  example = "Surface Type 1 description",
			  required = true,
			  position = 2)
