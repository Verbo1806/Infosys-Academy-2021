package bg.infosys.example.ws.controller.handler;
...
import bg.infosys.example.ws.controller.error.APIError;
import bg.infosys.example.ws.controller.error.APIErrorCodes;
